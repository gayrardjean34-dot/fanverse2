  ...
  return (
    <main>
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <video src="/images/LOGOO4K.webm" autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-contain" />
      </div>
      ...
      <footer className="py-8 bg-transparent relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-3">
          ...
          <div className="flex items-center gap-6 text-sm text-gray-500">
            ...
            {/* Discord button — hidden for now, re-enable when ready
