...
import { Home, LogOut, Sparkles, CreditCard, Workflow, Menu, X, Paintbrush, Coins, MessageCircle } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <img src="/images/JUSTE%20LE%20TEXTE.png" alt="Fanverse" className="h-6 object-contain max-w-[120px]" />
          </Link>
